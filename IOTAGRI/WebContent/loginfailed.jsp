			...
			<div id="page-wrapper" class="sign-in-wrapper">
				<div class="graphs">
					<div class="sign-in-form">
						...
						<div class="signin">
							...
							<div class="log-input">
								<div class="log-input-left">
								   <input type="text" class="user" id="id" value="id" name="id" onfocus="this.value = '';" onblur="if (this.value == '') {this.value = 'Email address:';}"/>
								</div>
							...
							<div class="log-input">
								<div class="log-input-left">
								   <input type="password" class="lock" id="password" value="password" name="password"onfocus="this.value = '';" onblur="if (this.value == '') {this.value = 'Email address:';}"/>
								</div>
						...
						</font> <font color="red"><b>${msg} <b></b></font>
						</div>
