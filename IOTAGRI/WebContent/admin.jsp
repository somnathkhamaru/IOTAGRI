    ...
    <!-- left side start-->
		...
		<!-- //header-ends -->
			<div id="page-wrapper">
				<div class="graphs">
					<div class="col_4">
						<div class="col-sm-4 widget widget1">
							<!--<div class="r3_counter_box">-->
							<iframe width="450" height="260" style="border: 1px solid #cccccc;" src="https://thingspeak.com/channels/227051/charts/1?bgcolor=%23ffffff&color=%23d62020&dynamic=true&results=5&title=Humidity+Variation&type=spline&yaxis=Humudity+%28+%25+%29"></iframe>

							<!--</div>-->
						</div>
						<div class="col-sm-4 widget widget1">
							<!--<div class="r3_counter_box">-->
								<iframe width="450" height="260" style="border: 1px solid #cccccc;" src="https://thingspeak.com/channels/227051/charts/2?bgcolor=%23ffffff&color=%23d62020&dynamic=true&results=5&title=Temperature+Variation&type=spline&yaxis=Temperature%28deg+Celsius%29&yaxismax=45&yaxismin=-5"></iframe>

							<!--</div>-->
						 </div>
						 <div class="col-sm-4 widget">
							<!--<div class="r3_counter_box">-->
								<iframe width="450" height="260" style="border: 1px solid #cccccc;" src="https://thingspeak.com/channels/227051/charts/3?bgcolor=%23ffffff&color=%23d62020&dynamic=true&results=5&title=Moisture+Variation&type=spline&yaxis=Moisture+%28+%25+%29+"></iframe>
